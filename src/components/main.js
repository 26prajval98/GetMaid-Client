            ...
            <div className="w3-modal w3-show">
                <div className="w3-modal-content w3-animate-top w3-card-4">
                    ...
                    <div className="w3-container w3-padding-large w3-center">
                        <input value={props.loginDetails.EmailOrPhone} placeholder="Email or Phone number" onChange={(e)=>actionMain.updateLoginEmailOrPw(e)} className="w3-input w3-center w3-margin-top" style={{ outline: "none" }} />
